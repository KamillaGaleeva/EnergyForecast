...
def compare_models():
    ...
    for metric in ['mae', 'rmse', 'r2']:
        ...
        better = new_val > prod_val if metric == 'r2' else new_val < prod_val
        print(f"{metric:<10} {prod_val:<15.4f} {new_val:<15.4f} {'yes' if better else 'no'}")
